...
#include "unsteadyABLInflowTFvPatchScalarField.H"
...
namespace Foam
{
  namespace incompressible
  {
    ...
    unsteadyABLInflowTFvPatchScalarField::
    unsteadyABLInflowTFvPatchScalarField
    (
     const fvPatch& p,
    ...
    unsteadyABLInflowTFvPatchScalarField
    (
     const unsteadyABLInflowTFvPatchScalarField& pvf,
     const fvPatch& p,
     const DimensionedField<scalar, volMesh>& iF,
    ...
    // * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //
    void unsteadyABLInflowTFvPatchScalarField::autoMap
    (
    ...
    void unsteadyABLInflowTFvPatchScalarField::rmap
    (
     ...
     )
    {
      ...
      //      const unsteadyABLInflowTFvPatchScalarField& nrwfpsf =
      //	refCast<const unsteadyABLInflowTFvPatchScalarField>(ptf);
    }

    void unsteadyABLInflowTFvPatchScalarField::updateCoeffs()
    {
      if (this->updated())
	{
	  return;
    ...
    tmp<scalarField> unsteadyABLInflowTFvPatchScalarField::TRef(const vector&flowdir) const
    {
      ...
      const scalarIOList&  Tvalues=this->db().lookupObject<scalarIOList>("vertTProfile");
    ...
    void unsteadyABLInflowTFvPatchScalarField::write(Ostream& os) const
    {
